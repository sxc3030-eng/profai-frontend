#!/usr/bin/env python3
"""Execute le stress reproductible du routage adaptatif Noyau Zero."""
...
from memory_agent.mat9f import MAT9FError  # noqa: E402
from memory_agent.mat9f_zero_adaptive_stress import (  # noqa: E402
    MAT9FZeroAdaptiveStressError,
    PROFILE_CASES,
    run_adaptive_zero_stress,
)
...
def main(argv: list[str] | None = None) -> int:
    try:
        ...
        report = run_adaptive_zero_stress(
        ...
        sys.stderr.write(f"Erreur stress adaptatif Noyau Zero: {error}\n")
        return 2
    sys.stdout.write(
        json.dumps(report, ensure_ascii=False, allow_nan=False, sort_keys=True, indent=2)
        + "\n"
