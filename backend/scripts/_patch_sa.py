...
# add not_legal_advice=True and specific effects to the advised return
effects = 'credential_collected=False,message_sent=False,action_performed=False,network_used=False,file_io=False,not_legal_advice=True'
